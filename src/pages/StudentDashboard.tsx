    ...
    <AppShell role="student">
      <header className="page-header">
        <div>
          ...
          <p>Sube tu artículo en PDF o DOCX. Cada corrección queda registrada como una nueva versión y los informes institucionales o externos aparecen únicamente cuando el coordinador los libera.</p>
        </div>
      ...
      {loading ? <div className="panel-card inline-loading"><span className="mini-spinner" />Cargando tus documentos…</div> : documents.length === 0 ? (
        <section className="student-empty-state">
          ...
          <p>Tu primer archivo quedará almacenado de forma privada, con huella SHA-256, historial de versiones y texto preparado para los análisis de similitud.</p>
      ...
      <section className="privacy-card">
        ...
        <p>Puedes consultar únicamente tus documentos y los análisis que el coordinador haya liberado. Las exclusiones, nuevas búsquedas externas y decisiones sobre el porcentaje final son de solo lectura para tu cuenta.</p>
      </section>
